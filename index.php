      ...
      <div class="container-fluid">
        <div class="row intro py-1" style="background-color: black">
            ...
            <div class="col-sm-12 col-md img text-center">
                <img src="bank.jpg" alt="bankimg" class="img-fluid pt-2">
            </div>
        </div>

        <div class="row activity text-center">
          <div class="col-md act">
                <img src="transfer.jpg" alt="transferimg" class="img-fluid">
                <br>
                <a href="transfermoney.php"><button style="background-color: #C86DFB;" >Make a Transaction</button></a>
            </div>

            <div class="col-md act">
                <img src="history.jpg" alt="historyimg" class="img-fluid">
                <br>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-4 align-self-center">
                        <div style="display: flex;justify-content: center;align-items: center; " class="text-center" >
                            <a class="btn btn-social-icon btn-linkedin"  style="color:#00FFFF" href="https://www.linkedin.com/in/kuldeep-meena-294bb61a0" title="go to my linkedin"><i class="fa fa-linkedin "></i></a>                      
                            <a class="btn btn-social-icon btn-instagram" style="color:#FF0000" href="https://www.instagram.com/kuldeep_meena_kkm" title ="go to my instagram"><i class="fa fa-instagram"></i></a>
                ...
                <div class="row justify-content-center">
                      <div class="col-auto" style="color:blue">
                         <p> Designed by- <b>KULDEEP MEENA</b></p>
                      </div>
                </div>
            </div>
        </footer>
